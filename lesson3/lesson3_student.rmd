...
ggplot(data = pf, aes(x = friend_count)) + 
    geom_histogram(binwidth = 25) + scale_x_continuous(lim=c(0,1000),breaks = seq(0,1000,50)) + facet_wrap(~gender)
...
qplot(x=friend_count,data =na.omit(pf),binwidth=10)+ scale_x_continuous(lim=c(0,1000),breaks = seq(0,1000,50)) + facet_wrap(~gender)

# na.omit will remove any row or column with a missing value which can be problem
